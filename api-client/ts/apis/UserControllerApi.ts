...
export class UserControllerApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async _delete(id: string, _options?: Configuration): Promise<RequestContext> {
        ...
        if (id === null || id === undefined) {
            throw new RequiredError("UserControllerApi", "_delete", "id");
        }
     ...
     */
    public async create(createUserRequest: CreateUserRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'createUserRequest' is not null or undefined
        if (createUserRequest === null || createUserRequest === undefined) {
            throw new RequiredError("UserControllerApi", "create", "createUserRequest");
        }
...
export class UserControllerApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async create(response: ResponseContext): Promise<User > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
